...
## 🔥 最新更新: v7.26.2 (2025-12-17)

**PDF 报告生成修复**:
- ✅ v7.26: 封面优化、目录补全、章节连续输出
- ✅ v7.26.1: 修复专家报告正文缺失（`content` 黑名单问题）
- ✅ v7.26.2: 修复第四章/第五章"暂无数据"（fallback 路径缺失字段）

**核心问题修复** (v7.20-v7.25):
- ✅ v7.25: 专家动态名称前端显示修复
- ✅ v7.24: 问卷 resume 重复生成、interrupt 捕获、WebSocket 重试
- ✅ v7.23: DeliverableFormat 枚举扩展、问卷关键词注入
- ✅ v7.22: 角色名称字段不一致修复
- ✅ v7.21: 进度显示节点名称映射修复
- ✅ v7.20: Pydantic 枚举验证失败修复
