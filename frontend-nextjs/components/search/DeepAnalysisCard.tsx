  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-gray-800">L1 事实层</span>
      </div>
            ...
            >
              ...
              <div className="space-y-2">
                {section.data.map((entity: any, idx: number) => (
                  <div key={idx} className="text-xs text-gray-600 dark:text-gray-700">
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-gray-800">L2 多视角分析</span>
      </div>
            ...
            {perspective.key_considerations && perspective.key_considerations.length > 0 && (
              <div className="flex flex-wrap gap-1">
                {perspective.key_considerations.slice(0, 3).map((consideration, i) => (
                  <span
                    key={i}
                    className="text-xs bg-white dark:bg-white text-gray-600 dark:text-gray-600 px-2 py-0.5 rounded border border-gray-200 dark:border-gray-300"
                  >
                    {consideration}
                  </span>
                ))}
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-gray-800">L3 核心张力</span>
      </div>
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-gray-800">L4 用户任务 (JTBD)</span>
      </div>
      <div className="bg-emerald-50 dark:bg-emerald-900/10 rounded-lg p-4 border border-emerald-200 dark:border-emerald-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {task.functional_job && (
            <div className="bg-white dark:bg-white rounded p-2 border border-emerald-200 dark:border-emerald-300">
              <span className="text-xs text-emerald-600 dark:text-emerald-600 font-medium block mb-1">功能任务</span>
              <span className="text-xs text-gray-600 dark:text-gray-600">{task.functional_job}</span>
            </div>
          )}
          {task.emotional_job && (
            <div className="bg-white dark:bg-white rounded p-2 border border-emerald-200 dark:border-emerald-300">
              <span className="text-xs text-emerald-600 dark:text-emerald-600 font-medium block mb-1">情感任务</span>
              <span className="text-xs text-gray-600 dark:text-gray-600">{task.emotional_job}</span>
            </div>
          )}
          {task.social_job && (
            <div className="bg-white dark:bg-white rounded p-2 border border-emerald-200 dark:border-emerald-300">
              <span className="text-xs text-emerald-600 dark:text-emerald-600 font-medium block mb-1">社会任务</span>
              <span className="text-xs text-gray-600 dark:text-gray-600">{task.social_job}</span>
            </div>
          )}
        </div>
      </div>
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-gray-800">L5 锐度评估</span>
      </div>
      <div className="bg-purple-50 dark:bg-purple-900/10 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {sharpness.specificity && (
            <div className="bg-white dark:bg-white rounded p-2 border border-purple-200 dark:border-purple-300">
              <span className="text-xs text-purple-600 dark:text-purple-600 font-medium block mb-1">具体性</span>
              <span className="text-xs text-gray-600 dark:text-gray-600">{sharpness.specificity}</span>
            </div>
          )}
          {sharpness.actionability && (
            <div className="bg-white dark:bg-white rounded p-2 border border-purple-200 dark:border-purple-300">
              <span className="text-xs text-purple-600 dark:text-purple-600 font-medium block mb-1">可操作性</span>
              <span className="text-xs text-gray-600 dark:text-gray-600">{sharpness.actionability}</span>
            </div>
          )}
          {sharpness.depth && (
            <div className="bg-white dark:bg-white rounded p-2 border border-purple-200 dark:border-purple-300">
              <span className="text-xs text-purple-600 dark:text-purple-600 font-medium block mb-1">深度</span>
              <span className="text-xs text-gray-600 dark:text-gray-600">{sharpness.depth}</span>
            </div>
          )}
        </div>
          ...
          <div className="mt-3 pt-3 border-t border-purple-200 dark:border-purple-700">
            ...
            <ul className="mt-1 space-y-1">
              {sharpness.improvement_suggestions.map((suggestion, idx) => (
                <li key={idx} className="text-xs text-gray-600 dark:text-gray-700 flex items-start gap-1">
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-gray-800">人性化维度</span>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {/* 情感地图 */}
