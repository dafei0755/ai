...
def _merge_phase_results(phase1: Dict, phase2: Dict, user_input: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "core_objectives": [structured_output.get("project_task", "")[:100]] if structured_output.get("project_task") else [],
...
class RequirementsAnalystCompat:
    ...
    def execute(
        ...
        config=None,
        store=None,
        use_two_phase: bool = True  # 默认使用 StateGraph 模式
    ) -> AnalysisResult:
        """
        兼容原接口的 execute 方法
        """
