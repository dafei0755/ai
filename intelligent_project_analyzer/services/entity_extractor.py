...
"""
    ...
    def _extract_brands(self, text: str, user_input: str) -> List[Dict[str, Any]]:
        ...
        brand_keywords = [
            "HAY", "IKEA", "Muji", "无印良品", "Herman Miller", "Vitra",
            "Cassina", "B&B Italia", "Knoll", "Artek", "Fritz Hansen",
            "品牌", "家居品牌", "设计品牌"
        ]
    ...
    def _extract_styles(self, text: str, user_input: str) -> List[Dict[str, Any]]:
        ...
        style_keywords = [
            "北欧", "简约", "现代", "工业风", "侘寂", "极简", "日式",
            "中式", "新中式", "法式", "美式", "轻奢", "复古", "vintage"
        ]
