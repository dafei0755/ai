...
import pytest
from intelligent_project_analyzer.agents.feasibility_analyst import CostCalculator, ConflictDetector, PriorityEngine
...
MOCK_INDUSTRY_STANDARDS = {
    "version": "1.0",
    "residential_costs": {
        "smart_home": {"core_system": {"total_cost": [40000, 70000]}},
        "home_theater": {"standard": {"total_cost": [60000, 120000]}},
    },
    "conflict_thresholds": {
        "budget": {"critical": 1.5, "high": 1.25, "medium": 1.1, "low": 1.05},
        "timeline": {"critical": 2.0, "high": 1.5, "medium": 1.2, "low": 1.1},
        "space": {"critical": 1.5, "high": 1.3, "medium": 1.15, "low": 1.05},
    },
    "stakeholder_weights": {
        "residential": {"owner": 0.40, "family_members": 0.30, "guests": 0.15, "investment_value": 0.15}
    },
    "necessity_levels": {
        "survival": {"weight": 1.0},
        "safety": {"weight": 0.85},
...
class TestCostCalculator:
    ...
    def test_estimate_combined_cost(self):
        ...
        # 智能家居 + 私人影院
        min_cost, typical_cost, max_cost = calculator.estimate_cost("全屋智能家居系统和私人影院")
...
class TestConflictDetector:
    ...
    def test_budget_conflict_critical(self):
        ...
        # 20万预算，但需求成本34万
        conflict = detector.detect_budget_conflict(available_budget=200000, estimated_cost=340000)
    ...
    def test_budget_conflict_high(self):
        ...
        # 20万预算，但需求成本27万
        conflict = detector.detect_budget_conflict(available_budget=200000, estimated_cost=270000)
    ...
    def test_budget_conflict_none(self):
        ...
        # 30万预算，需求成本25万
        conflict = detector.detect_budget_conflict(available_budget=300000, estimated_cost=250000)
    ...
    def test_timeline_conflict_critical(self):
        ...
        conflict = detector.detect_timeline_conflict(available_days=60, required_days=90)
    ...
    def test_space_conflict_critical(self):
        ...
        conflict = detector.detect_space_conflict(available_area=60, required_area=86)
    ...
    def test_budget_undefined(self):
        ...
        conflict = detector.detect_budget_conflict(available_budget=None, estimated_cost=200000)
...
class TestIntegration:
    ...
    def test_case1_smart_home_flexible_budget(self):
        ...
        # 预算冲突检测（预算未明确）
        detector = ConflictDetector(MOCK_INDUSTRY_STANDARDS)
        conflict = detector.detect_budget_conflict(available_budget=None, estimated_cost=typical_cost)
    ...
    def test_case2_budget_conflict_20w_for_luxury_villa(self):
        ...
        # 成本估算
        calculator = CostCalculator(MOCK_INDUSTRY_STANDARDS)
        min_cost, typical_cost, max_cost = calculator.estimate_cost("全进口材料、智能家居系统、私人影院")
        ...
        # 冲突检测
        detector = ConflictDetector(MOCK_INDUSTRY_STANDARDS)
        conflict = detector.detect_budget_conflict(available_budget=200000, estimated_cost=340000)  # 假设总成本34万
    ...
    def test_case3_timeline_conflict_2months_for_fine_work(self):
        ...
        # 工期冲突检测
        detector = ConflictDetector(MOCK_INDUSTRY_STANDARDS)
        conflict = detector.detect_timeline_conflict(available_days=60, required_days=90)  # 2个月  # 精装修标准工期
