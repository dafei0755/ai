...
class TestV716Integration(unittest.TestCase):
    ...
    def test_02_challenge_detection_compatibility(self):
        ...
        test_state = {"agent_results": {"V4_设计研究员_4-1": {"structured_data": {"analysis": "完成"}}}, "batch_results": {}}
    ...
    def test_04_questionnaire_agent_compatibility(self):
        ...
        start = time.time()
        result = agent.generate(user_input="我需要一套150平米的住宅设计", structured_data={"project_type": "住宅设计"})
        exec_time = time.time() - start
