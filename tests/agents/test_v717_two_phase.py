...
# This test exercises real LLM execution (or requires a realistic LLM stub).
# Keep it out of the default CI/fast suite.
...
def test_two_phase_analysis():
    ...
    # 模拟 state
    state_sufficient = {"session_id": "test_v717_sufficient", "user_input": test_input_sufficient}

    state_insufficient = {"session_id": "test_v717_insufficient", "user_input": test_input_insufficient}
