...
class TestComplexityAssessment:
    ...
    def test_poetic_concept_long_description(self, classifier):
        ...
        assert result["complexity"] in ["simple", "medium"], f"诗意书房应为simple/medium，但判定为{result['complexity']}"
    ...
    def test_large_area_market(self, classifier):
        ...
        assert result["complexity"] == "complex", f"20000平米项目应为complex，实际{result['complexity']}"
    ...
    def test_length_independence_simple(self, classifier):
        ...
        # 核心断言：无论描述长短，复杂度应一致
        assert (
            result_short["complexity"] == result_long["complexity"]
