...
from intelligent_project_analyzer.security import ContentSafetyGuard, DomainClassifier, SafeLLMWrapper, ViolationLogger
...
class TestDomainClassifier:
    ...
    def test_clear_design_query(self):
        """测试明确的设计问题"""
        queries = ["我需要设计一个咖啡厅，面积100平米", "帮我规划一个现代简约风格的办公空间", "这个展厅如何体现科技感", "住宅客厅的动线设计要注意什么"]
    ...
    def test_clear_non_design_query(self):
        """测试明确的非设计问题"""
        queries = ["用Python写一个爬虫程序", "如何治疗感冒", "这个合同条款有法律风险吗", "推荐一部好看的电影"]
...
class TestViolationLogger:
    ...
    def test_get_statistics(self):
        ...
        # 记录几条测试数据
        for i in range(3):
            self.logger.log({"session_id": f"test-{i}", "violation_type": "content_safety", "details": {}})
