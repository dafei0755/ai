...
class TestV3_1_FlexibleOutput:
    ...
    def test_comprehensive_mode_valid(self):
        ...
        data = {
            ...
            "key_spatial_moments": [
                {"touchpoint_name": "早晨出门前", "emotional_goal": "高效有序，减少焦虑", "sensory_script": "充足储物，快速动线，柔和晨光"}
            ],
...
class TestV3_2_FlexibleOutput:
    ...
    def test_touchpoint_script_nested_model(self):
        ...
        touchpoint = TouchpointScript(
            touchpoint_name="进入店铺", emotional_goal="让顾客感到受欢迎和期待", sensory_script="宽敞入口，柔和灯光，清晰导视，吸引力陈列"
        )
...
class TestV3V4SeriesIntegration:
    ...
    def test_v3_models_have_touchpoint_or_narrative_fields(self):
        ...
        for model in v3_models:
            ...
            has_narrative_field = any(
                "narrative" in field.lower() or "touchpoint" in field.lower() or "spatial_moments" in field.lower()
                for field in model_fields
            )
            assert has_narrative_field, f"{model.__name__} should have narrative-related fields"
    ...
    def test_comprehensive_mode_v3_models(self):
        ...
        v3_1_data = {
            ...
            "key_spatial_moments": [
                {"touchpoint_name": "早晨出门", "emotional_goal": "高效有序", "sensory_script": "快速动线，柔和光线"}
            ],
        ...
        v3_2_data = {
            ...
            "key_touchpoint_scripts": [
                {"touchpoint_name": "进店", "emotional_goal": "感到欢迎", "sensory_script": "宽敞入口，柔和灯光"}
            ],
        ...
        v3_3_data = {
            ...
            "key_spatial_moments": [
                {"touchpoint_name": "入口体验", "emotional_goal": "好奇期待", "sensory_script": "开敞空间，迎宾氛围"}
            ],
            "narrative_guidelines_for_v2": "叙事指导...",
        }
