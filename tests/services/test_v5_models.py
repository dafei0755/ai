    ...
    def test_comprehensive_mode_valid(self):
        ...
        data = {
            ...
            "design_challenges_for_v2": [
                {"challenge": "高峰期客流拥挤", "context": "午餐时段12-14点客流集中", "constraints": ["面积有限", "无法大幅扩张", "预算受限"]}
            ],
        }
...
class TestV5_1_FlexibleOutput:
    ...
    def test_targeted_mode_valid(self):
        ...
        data = {
            ...
            "targeted_analysis": {
                "circulation_strategy": {"key_principle": "动静分离，减少干扰", "design_approach": "主卧套房化，老人房靠近客厅"}
            },
        }
    ...
    def test_comprehensive_mode_with_nested_models(self):
        ...
        data = {
            ...
            "design_challenges_for_v2": [
                {"challenge": "三代作息冲突", "context": "老人早睡，年轻人晚睡", "constraints": ["面积有限", "隔音要求高"]}
            ],
        }
...
class TestV5_2_FlexibleOutput:
    ...
    def test_retail_kpi_nested_model(self):
        """测试嵌套模型RetailKPI"""
        kpi = RetailKPI(metric="坪效", target="年坪效≥3万元/㎡", spatial_strategy="需优化商品陈列密度和动线效率")
...
class TestV5_OtherScenarios:
    ...
    def test_v5_4_hospitality_scenario(self):
        ...
        data = {
            ...
            "targeted_analysis": {
                "service_optimization": {"check_in_time": "从15分钟降至5分钟", "room_turnover": "清洁效率提升20%"}
            },
        }
    ...
    def test_v5_5_cultural_scenario(self):
        ...
        data = {
            ...
            "targeted_analysis": {"visitor_flow": {"route_design": "线性叙事 + 主题跳转", "dwell_time": "平均每展区15分钟"}},
        }
    ...
    def test_v5_6_healthcare_scenario(self):
        ...
        data = {
            ...
            "targeted_analysis": {
                "clinical_flow": {"registration_to_consultation": "从30分钟降至15分钟", "privacy_zones": "设置独立问诊隔间"}
            },
        }
...
class TestV5SeriesIntegration:
    ...
    def test_all_v5_models_have_design_challenges_for_v2(self):
        ...
        for model in models:
            model_fields = model.model_fields.keys()
            assert (
                "design_challenges_for_v2" in model_fields
    ...
    def test_comprehensive_mode_all_v5_models(self):
        ...
        v5_0_data = {
            ...
            "design_challenges_for_v2": [{"challenge": "测试挑战", "context": "测试上下文", "constraints": ["约束1"]}],
        }
        ...
        v5_1_data = {
            ...
            "design_rationale": "系统分析",
            "family_profile_and_needs": [
                {"member": "测试成员", "daily_routine": "日常作息", "spatial_needs": ["需求1"], "storage_needs": ["储物1"]}
            ],
        ...
        v5_2_data = {
            ...
            "key_performance_indicators": [
                {"metric": "坪效", "target": "年坪效≥3万元/㎡", "spatial_strategy": "优化商品陈列密度和动线效率"}
            ],
            "design_challenges_for_v2": [{"challenge": "测试挑战", "context": "测试上下文", "constraints": ["约束1"]}],
        }
