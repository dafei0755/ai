...
def client():
    ...
    with patch("intelligent_project_analyzer.api.server.session_manager", mock_session_manager), \
         patch("intelligent_project_analyzer.api.server.archive_manager", mock_archive_manager):
