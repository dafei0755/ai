...
class TestWorkflowFlagManager:
    ...
    def test_preserve_multiple_flags(self):
        """测试保留多个标志"""
        state = {"skip_unified_review": True, "is_followup": True, "skip_calibration": True, "user_input": "test"}
        update = {"calibration_processed": True}
    ...
    def test_exclude_flags(self):
        """测试排除特定标志"""
        state = {"skip_unified_review": True, "is_followup": True, "skip_calibration": True}
        update = {"calibration_processed": True}

        result = WorkflowFlagManager.preserve_flags(state, update, exclude={"skip_calibration"})
    ...
    def test_clear_flags(self):
        ...
        result = WorkflowFlagManager.clear_flags(update, flags={"skip_unified_review", "is_followup"})
